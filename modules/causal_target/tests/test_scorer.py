"""
Tests for causal_target.scorer
================================
"""

import pytest
from modules.causal_target.scorer import (
    score_candidate,
    rank_candidates,
    normalise_affinity,
    normalise_sa,
...
from modules.causal_target.models import ScoredCandidate
...
class TestWeights:
    ...
    def test_causal_confidence_highest(self):
        ...
        assert WEIGHTS["causal_confidence"] == max_weight
...
class TestScoreCandidate:
    ...
    def test_causal_beats_binding(self):
        ...
        This is the KEY design decision of CausalTarget.
        """
